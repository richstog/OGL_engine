...
namespace r_engine
{
    GLfloat cube_pos_norm_uv[] = {
        ...
        // back
        1.f, -1.f, -1.f,    1.f, 0.f, 0.f,      1.f, 0.f,   // 4
        1.f, 1.f, -1.f,     1.f, 0.f, 0.f,      0.f, 0.f,   // 5
        1.f, 1.f, 1.f,      1.f, 0.f, 0.f,      0.f, 1.f,   // 6
        1.f, -1.f, 1.f,     1.f, 0.f, 0.f,      1.f, 1.f,   // 7
        ...
        // left
        -1.f, -1.f, -1.f,   0.f, -1.f, 0.f,     1.f, 0.f,   // 12
        1.f, -1.f, -1.f,    0.f, -1.f, 0.f,     0.f, 0.f,   // 13
        1.f, -1.f, 1.f,     0.f, -1.f, 0.f,     0.f, 1.f,   // 14
        -1.f, -1.f, 1.f,    0.f, -1.f, 0.f,     1.f, 1.f,   // 15
        ...
        // bottom
        -1.f, -1.f, -1.f,   0.f, 0.f, -1.f,     0.f, 1.f,   // 20
        -1.f, 1.f, -1.f,    0.f, 0.f, -1.f,     1.f, 1.f,   // 21
        1.f, 1.f, -1.f,     0.f, 0.f, -1.f,     1.f, 0.f,   // 22
    ...
    void Application::draw()
    {
        ...
        // p_shader_program->setMatrix4("model_matrix", model_m);
        //p_shader_program->setInt("current_frame", current_frame++);

        p_shader_program->setVec3("light_position_eye", glm::vec3(camera.get_view_matrix() * glm::vec4(light_position[0], light_position[1], light_position[2], 1.f)));
